...
/**
 * This program computes (a) the correlations between distance measures of Tables 1 and 2; and (b)
 * the average distances induced by mutation operators for Figures 1, 2, 3, 4, and 5 from the paper:
 * <br>
 * V. A. Cicirello and R. Cernera, <a
 * href="https://www.cicirello.org/publications/cicirello2013flairs.html">"Profiling the distance
 * characteristics of mutation operators for permutation-based genetic algorithms,"</a> in
 * Proceedings of the 26th FLAIRS Conference. AAAI Press, May 2013, pp. 46–51.
 *
 * <p>NOTE: This is not the original code from this paper. Source code has been heavily refactored
 * since then, but results should correspond, at least statistically. One of the refactorings
 * involved using a different, more efficient random number generator. Since the data for the
 * figures is derived from a randomized process, the data is not identical to that used originally,
 * but should correspond statistically.
 *
...
public class Flairs2013 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Data from Tables 1 and 2 of the FLAIRS 2013 paper can be extracted from the following correlation matrix.");
