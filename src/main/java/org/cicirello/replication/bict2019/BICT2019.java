...
public class BICT2019 {
	 ...
	 * @param args The command line argument is optional. If specified, the first command
	 * line argument is the permutation length (defaults to 10 if not specified).
	 */
