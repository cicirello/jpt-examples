...
/**
 * Basic examples of the use of the classes from the org.cicirello.permutations.distance package.
 *
...
public class SimpleDistanceExamples {
  ...
  private SimpleDistanceExamples() {}
  ...
  public static void main(String[] args) {
    ...
    // Most implement both, except there are a couple that do not necessarily produce an integer
    // result,
    ...
    System.out.println(
        "Kendall tau distance is min number of adjacent swaps needed to transform p1 to p2.");
    System.out.println(
        "This example is the maximum case, when one permutation is reverse of the other.");
    ...
    System.out.println(
        "EditDistance with insertion and deletion costs equal to 1, and change cost equal to 2.");
