...
/**
 * Basic examples of the use of the classes from the org.cicirello.sequences.distance package.
 *
...
public class SequenceDistanceExamples {
  ...
  private SequenceDistanceExamples() {}
  ...
  public static void main(String[] args) {
    ...
    // such as arrays of any primitive type, arrays of objects, as well as the characters of a
    // String.
    ...
    System.out.println(
        "edit distance (cost of 1 for insertions, deletions, and changes) of s1 and s2: "
            + edit1.distance(s1, s2));
    System.out.println(
        "edit distance (cost of 1 for insertions, deletions, and 2 for changes) of s1 and s2: "
            + edit2.distance(s1, s2));
    ...
    System.out.println(
        "edit distance (cost of 1 for insertions, deletions, and changes) of a1 and a2: "
            + edit1.distance(a1, a2));
    System.out.println(
        "edit distance (cost of 1 for insertions, deletions, and 2 for changes) of a1 and a2: "
            + edit2.distance(a1, a2));
  }
}
