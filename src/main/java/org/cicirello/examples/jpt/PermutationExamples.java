...
/**
 * Basic examples of the use of the classes from the org.cicirello.permutations package, including
 * the {@link org.cicirello.permutations.Permutation Permutation} and {@link
 * org.cicirello.permutations.PermutationIterator PermutationIterator} classes.
 *
...
public class PermutationExamples {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "If you are running this example program, make sure you also read the source code and comments.");
    System.out.println(
        "Output of example program in isolation of the source and comments won't tell you much.");
    ...
    // Object.equals overridden to check if 2 permutation objects consist in the same permutation of
    // integers.
    if (p2.equals(p3)) {
    ...
    // several mutator methods to change state of permutation, such as reverse, rotate, swap, and
    // some others
    p1.reverse();
    ...
    // relatively easy.  In the following example, we iterate over all Permutations of length 4
    // beginning at
    // {3, 1, 0, 2}
