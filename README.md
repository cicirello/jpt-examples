...
* __JDK 11__: Beginning with v3.0.0, the minimum supported Java version for the 
  JavaPermutationTools library is Java 11, so you will need Java 11+ for the example programs. 
